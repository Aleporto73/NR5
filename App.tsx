...
const App: React.FC = () => {
  ...
  const scrollTo = (id: string) => {
    if (view !== 'home') {
      setView('home');
      // Delay scrolling to allow the view to change
      setTimeout(() => {
        ...
        <Container>
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => scrollTo('testes')} className="text-slate-600 hover:text-blue-900 font-medium transition-colors">Testes</button>
              <button 
            ...
            <Container>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                  ...
                  <p className="text-slate-600 leading-relaxed text-sm">
                    A anamnese antecede o rastreio, ajudando o profissional a definir foco, interpretar resultados com mais precisão e reduzir ruído clínico desde o início do acompanhamento.
                  </p>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                  <div className="h-2 w-12 bg-blue-900 rounded-full mb-6"></div>
              ...
              <p className="mt-10 text-center text-xs text-slate-400 max-w-2xl mx-auto">
                A anamnese não substitui avaliação clínica aprofundada. Ela organiza o ponto de partida técnico para the rastreio funcional.
              </p>
            </Container>
          </Section>
            ...
            <Container>
              ...
              <div className="flex justify-center">
                <div className="w-full max-w-lg bg-white p-8 md:p-10 rounded-3xl shadow-lg border border-slate-200 text-center">
                  ...
                  <Button onClick={handlePurchase} className="w-full text-lg py-4 mb-6">
                    Use por 7 dias. Reembolso fácil.
                  </Button>
